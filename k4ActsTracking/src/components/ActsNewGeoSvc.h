...
class ActsNewGeoSvc : public extends<Service, IActsGeoSvc> {
public:
...
public:
  ActsNewGeoSvc(const std::string& name, ISvcLocator* svc);

  virtual ~ActsNewGeoSvc();
...
inline const Acts::TrackingGeometry& ActsNewGeoSvc::trackingGeometry() const { return *m_trackingGeo; }
inline const Acts::GeometryContext& ActsNewGeoSvc::geometryContext() const { return m_trackingGeoCtx; }
